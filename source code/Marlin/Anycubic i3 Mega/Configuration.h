...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // i3 Mega stock v5 hotend, 40W heater cartridge (3.6Ω @ 22°C)
    ...
    #define DEFAULT_Kp_LIST {  24.73,  24.73 } //jumbo125
    #define DEFAULT_Ki_LIST {   1.83,   1.83 }	//jumbo125
    #define DEFAULT_Kd_LIST {  83.56,  583.56 }	//jumbo125
  #else
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 121.66 //jumbo125
  #define DEFAULT_bedKi .023 //jumbo125
  #define DEFAULT_bedKd 305.4 //jumbo125
...
#define EXTRUDE_MAXLENGTH 800 //Jumbo125
 ...
 * :[2,3,4,5,6,7]
 */
#define ENDSTOP_NOISE_THRESHOLD 2 //jumbo125

// Check for stuck or disconnected endstops during homing moves.
#define DETECT_BROKEN_ENDSTOP //jumbo125
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 8, 60 } //jumbo125
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 2000,  60, 10000 } //jumbo125
 ...
 *     O-- FRONT --+
 */
//#define NOZZLE_TO_PROBE_OFFSET { 0, -23, -1.54 } jumbo125 was default
#define NOZZLE_TO_PROBE_OFFSET {  0, 0, 0 } //jumbo125
 ...
 */
//#define MULTIPLE_PROBING 2 //jumbo125
//#define EXTRA_PROBING    1 //jumbo125
...
#define DELAY_BEFORE_PROBING 100  // (ms) To prevent vibrations from triggering piezo sensors //jumbo125

// Require minimum nozzle and/or bed temperature for probing
//#define PREHEAT_BEFORE_PROBING
#if ENABLED(PREHEAT_BEFORE_PROBING)
  #define PROBING_NOZZLE_TEMP 120   // (°C) Only applies to E0 at this time
  #define PROBING_BED_TEMP     60 //jumbo125
#endif
...
#define Y_BED_SIZE 220	//jumbo125
...
#if DISABLED(I3MEGA_HAS_BLTOUCH)
  //#define MESH_BED_LEVELING //jumbo125 disabled
  #define AUTO_BED_LEVELING_BILINEAR  // ENABLE FOR BLTOUCH or Mesh bed LEveling mit probe_manually Jumbo125
#endif
 ...
 */
#define RESTORE_LEVELING_AFTER_G28 // ENABLE FOR BLTOUCH Jumbo125 
...
//#define PREHEAT_BEFORE_LEVELING
  ...
  #define LEVELING_BED_TEMP     60 //Jumbo125
#endif
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MANUAL_PROBE_START_Z 0.3  // (mm) Comment out to use the last-measured height //jumbo125
#endif
  ...
  #define GRID_MAX_POINTS_X 5	//jumob125 
 ...
 */
#define LCD_BED_LEVELING //jumbo125
...
#define LEVEL_BED_CORNERS //jumbo125
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 10  // X point for Z homing Jumbo125
  #define Z_SAFE_HOMING_Y_POINT 10  // X point for Z homing Jumbo125
#endif
