...
#define STRING_CONFIG_H_AUTHOR "(Jumbo125 remake from CHAD, Ender-3 Max)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_CREALITY_V427 //BOARD_CREALITY_V4 (für 4.2.2) Jumbo125
#endif

// Name displayed in the LCD "Ready" message and Info menu
#define CUSTOM_MACHINE_NAME "Ender-3 Max 4.2.7"  //Ender-3 Max 4.2.2 Jumbo125
